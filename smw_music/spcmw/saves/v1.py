...
def _load_sample(sample: SampleDict) -> v2.SampleDict:
    rv: v2.SampleDict = {
        ...
        "dynamics": {
            "pppp": sample["dynamics"][1],
            "ppp": sample["dynamics"][2],
            "pp": sample["dynamics"][3],
            "p": sample["dynamics"][4],
            "mp": sample["dynamics"][5],
            "mf": sample["dynamics"][6],
            "f": sample["dynamics"][7],
            "ff": sample["dynamics"][8],
            "fff": sample["dynamics"][9],
            "ffff": sample["dynamics"][10],
        },
