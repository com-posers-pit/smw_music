...
def _load_sample(inst: SampleDict) -> InstrumentSample:
    return InstrumentSample(
        ...
        params=SampleParams(
            ...
            tuning=inst["tune_setting"],
            subtuning=inst["subtune_setting"],
        ),
        mute=inst["mute"],
        solo=inst["solo"],
...
def _save_sample(sample: InstrumentSample) -> SampleDict:
    return {
        ...
        "sus_level_setting": sample.params.envelope.sus_level_setting,
        "sus_rate_setting": sample.params.envelope.sus_rate_setting,
        "gain_mode": sample.params.envelope.gain_mode.value,
        "gain_setting": sample.params.envelope.gain_setting,
        "tune_setting": sample.params.tuning,
        "subtune_setting": sample.params.subtuning,
        "mute": sample.mute,
        "solo": sample.solo,
